...
import { HomeServices } from "@/app/home-services";
...
export const metadata = {
  ...
  openGraph: { title: SITE_TITLE, description: SITE_DESCRIPTION, url: "/", siteName: "TD Studios", type: "website" },
  twitter: { card: "summary_large_image" as const, title: SITE_TITLE, description: SITE_DESCRIPTION },
};
...
export default async function Home(props: PageProps<"/">) {
  ...
  return (
    ...
    <main>
      <section aria-label="TD Studios" className="on-glass home-shell relative flex min-h-svh flex-col items-center justify-center overflow-hidden">
